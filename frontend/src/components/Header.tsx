  ...
  return (
    <header className="bg-gray-800 text-white px-6 py-4 flex items-center justify-center">
      ...
      <nav className="flex space-x-4">
        <button className="hover:bg-gray-700 px-3 py-2 rounded" onClick={() => {
        ...
        <button className="hover:bg-gray-700 px-3 py-2 rounded"onClick={() => {
          ...
          }}>Groupes Politiques</button>
        <button className="hover:bg-gray-700 px-3 py-2 rounded">Dashboard mensuel</button>
